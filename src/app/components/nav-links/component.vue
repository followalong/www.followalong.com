<template>
  <nav class="mt-5 flex-1 space-y-1 bg-white px-2 pb-8">
    ...
    <!-- <a href="#" class="relative text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 sm:text-sm font-medium rounded-md">
    ...
    <h3 class="pt-5 pb-1 uppercase text-gray-400 text-sm sm:text-xs">
      My Account
    </h3>
    <router-link
      to="/following"
