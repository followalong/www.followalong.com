          ...
          >
            <div class="flex items-center justify-end">
              ...
              >
                ...
                <div
                  class="absolute right-0 z-10 mt-2 w-screen max-w-md px-2 sm:px-0"
                  style="dislay: none;"
                >
                  <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                    <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                      ...
                      >
                        ...
                        /></svg>
                        <div class="ml-4">
                          <p class="text-base font-medium text-gray-900">Add-ons</p>
                      ...
                      >
                        ...
                        <div class="ml-4">
                          <p class="text-base font-medium text-gray-900">Switch accounts</p>
          ...
          <div class="sticky top-0 flex min-h-0 flex-1 flex-col">
            <div class="flex flex-1 flex-col overflow-y-auto pt-5 pb-4">
              <nav class="mt-5 flex-1 space-y-1 bg-white px-2">
                <h3 class="pb-1 uppercase text-gray-400 text-sm">
                  Shortcuts
                </h3>
                <a
                  href="#"
                ...
                <!-- <h3 class="pt-5 pb-1 uppercase text-gray-400 text-sm">My Account</h3>
                <a href="#" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                  <svg viewBox="0 0 448 512" class="h-5 w-5 flex-shrink-0 text-gray-300 mr-3"><path fill="currentColor" d="M448 73.143v45.714C448 159.143 347.667 192 224 192S0 159.143 0 118.857V73.143C0 32.857 100.333 0 224 0s224 32.857 224 73.143zM448 176v102.857C448 319.143 347.667 352 224 352S0 319.143 0 278.857V176c48.125 33.143 136.208 48.572 224 48.572S399.874 209.143 448 176zm0 160v102.857C448 479.143 347.667 512 224 512S0 479.143 0 438.857V336c48.125 33.143 136.208 48.572 224 48.572S399.874 369.143 448 336z"></path></svg>
                  Feeds
                </a>
                <a href="#" class="text-gray-600 hover:bg-gray-50 hover:text-gray-900 group flex items-center px-2 py-2 text-sm font-medium rounded-md">
                ...
                <h3 class="pt-5 pb-1 uppercase text-gray-400 text-sm">
                  Follow Along
                </h3>
                <a
                  href="#"
            ...
            >
              <div class="border-b border-gray-200 pb-5 mb-8">
                <div class="sm:flex sm:items-baseline sm:justify-between">
                  <div class="sm:w-0 sm:flex-1">
                    <h1 class="text-lg font-medium text-gray-900 group flex items-center">
                      <!-- <svg viewBox="0 0 512 512" class="h-5 w-5 flex-shrink-0 text-gray-300 mr-3 group flex items-center"><path class="" fill="currentColor" d="M487.4 315.7l-42.6-24.6c4.3-23.2 4.3-47 0-70.2l42.6-24.6c4.9-2.8 7.1-8.6 5.5-14-11.1-35.6-30-67.8-54.7-94.6-3.8-4.1-10-5.1-14.8-2.3L380.8 110c-17.9-15.4-38.5-27.3-60.8-35.1V25.8c0-5.6-3.9-10.5-9.4-11.7-36.7-8.2-74.3-7.8-109.2 0-5.5 1.2-9.4 6.1-9.4 11.7V75c-22.2 7.9-42.8 19.8-60.8 35.1L88.7 85.5c-4.9-2.8-11-1.9-14.8 2.3-24.7 26.7-43.6 58.9-54.7 94.6-1.7 5.4.6 11.2 5.5 14L67.3 221c-4.3 23.2-4.3 47 0 70.2l-42.6 24.6c-4.9 2.8-7.1 8.6-5.5 14 11.1 35.6 30 67.8 54.7 94.6 3.8 4.1 10 5.1 14.8 2.3l42.6-24.6c17.9 15.4 38.5 27.3 60.8 35.1v49.2c0 5.6 3.9 10.5 9.4 11.7 36.7 8.2 74.3 7.8 109.2 0 5.5-1.2 9.4-6.1 9.4-11.7v-49.2c22.2-7.9 42.8-19.8 60.8-35.1l42.6 24.6c4.9 2.8 11 1.9 14.8-2.3 24.7-26.7 43.6-58.9 54.7-94.6 1.5-5.5-.7-11.3-5.6-14.1zM256 336c-44.1 0-80-35.9-80-80s35.9-80 80-80 80 35.9 80 80-35.9 80-80 80z"></path></svg> -->
                      Home
                    </h1>
              ...
              >
                <div class="bg-white shadow sm:rounded-lg">
                  ...
                  <!-- <div class="flex">
                    <a href="#" class="flex-1 bg-gray-50 px-4 py-4 text-center text-sm font-medium text-gray-500 hover:text-gray-700 sm:rounded-b-lg">View Source</a>
                    <a href="#" class="flex-1 bg-gray-50 px-4 py-4 text-center text-sm font-medium text-gray-500 hover:text-gray-700 sm:rounded-b-lg">Save</a>
                  </div> -->
                </div>
              </section>
